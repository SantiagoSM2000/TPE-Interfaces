(() => {
    ...
    const pipeSpriteSets = {
        bottom: [
            { minHeight: 188, src: "/TP5/src/assets/flappy_bird/Obstacles/test1.png" },
            { minHeight: 179, src: "/TP5/src/assets/flappy_bird/Obstacles/test2.png" },
            { minHeight: 92, src: "/TP5/src/assets/flappy_bird/Obstacles/test2.png" },
            { minHeight: 0, src: "/TP5/src/assets/flappy_bird/Obstacles/test2.png" }
        ],
        top: [
